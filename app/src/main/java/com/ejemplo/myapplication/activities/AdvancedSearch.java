...
public class AdvancedSearch extends AppCompatActivity {
    ...
    private void addPlantToUserCollection(PlantSuggestion suggestion) {
        ...
        PlantModel newPlant = new PlantModel(
                suggestion.getPlantName(),                // Nombre científico
                "Agregado automáticamente",               // Descripción (puedes ajustarla)
                (float) suggestion.getProbability(),      // Confianza
                suggestion.getInfoText(),                   // Información extra (de Wiki)
                imageUriString,                             // URI de la imagen
                ""                                          // customName (vacío inicialmente)
        );
